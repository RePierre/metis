...
def build_datasets(input_path, batch_size):
    ...
    txt1_train, txt1_test, \
        ...
        ttl1_train, ttl1_test = train_test_split(txt1, aff1, cit1, kwd1, ttl1)
    txt1_train, txt1_test, \
        aff1_train, aff1_test, \
        cit1_train, cit1_test, \
        kwd1_train, kwd1_test, \
        ttl1_train, ttl1_test = _accomodate_batch_size(batch_size,
                                                       txt1_train, txt1_test,
                                                       aff1_train, aff1_test,
                                                       cit1_train, cit1_test,
                                                       kwd1_train, kwd1_test,
    ...
    txt2_train, txt2_test, \
        ...
        ttl2_train, ttl2_test = train_test_split(txt2, aff2, cit2, kwd2, ttl2)
    txt2_train, txt2_test, \
        aff2_train, aff2_test, \
        cit2_train, cit2_test, \
        kwd2_train, kwd2_test, \
        ttl2_train, ttl2_test = _accomodate_batch_size(batch_size,
                                                       txt2_train, txt2_test,
                                                       aff2_train, aff2_test,
                                                       cit2_train, cit2_test,
                                                       kwd2_train, kwd2_test,
                                                       ttl2_train, ttl2_test)
